<template>
  <div id="layaContainer" class="live pk10Live">
    ...
    <div class="container">
      <div
        class="header"
        :class="curLotteryCode.indexOf('ft') != -1 ? 'ft' : 'sc'"
      >
        <div class="logo">
      ...
      <div class="scenary page1">
        <div class="scenaryitm" id="scenaryitm">
          <img
            src="../../../assets/video/images/ft/scenery.jpg"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="2668"
            height="170"
            alt
          />
          <img
            src="../../../assets/video/images/sc/scenery.jpg"
            v-else
            width="2668"
            height="170"
            alt
      ...
      <div class="road page1">
        <div class="roadani">
          <div class="roaditm" id="roaditm">
            <img
              src="../../../assets/video/images/ft/road.jpg"
              v-if="curLotteryCode.indexOf('ft') != -1"
              width="2660"
              height="520"
              alt
            />
            <img
              src="../../../assets/video/images/sc/road.jpg"
              v-else
              width="2660"
              height="520"
              alt
        ...
        <div
          class="roadstart"
          id="roadstart"
          :class="{ ft: curLotteryCode.indexOf('ft') != -1 }"
        >
          <img
            src="../../../assets/video/images/finisher.png"
            width="249"
            height="515"
            alt
          />
        ...
        <div class="car1" id="car1">
          <img
            src="../../../assets/video/images/ft/car1.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="160"
            height="44"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car1.png"
            v-else
            width="160"
            height="44"
            alt
          ...
          <div class="wheel1a">
            <img
              src="../../../assets/video/images/ft/wheel.png"
              v-if="curLotteryCode.indexOf('ft') != -1"
              width="20"
              height="20"
              alt
            />
            <img
              src="../../../assets/video/images/sc/wheel.gif"
              v-else
              width="20"
              height="20"
              alt
          ...
          <div class="wheel1b">
            <img
              src="../../../assets/video/images/ft/wheel2.png"
              v-if="curLotteryCode.indexOf('ft') != -1"
              width="20"
              height="20"
              alt
          ...
          <div class="wind">
            <img
              src="../../../assets/video/images/ft/wind.png"
              v-if="curLotteryCode.indexOf('ft') != -1"
              width="144"
              height="53"
              alt
            />
            <img
              src="../../../assets/video/images/sc/wind.png"
              v-else
              width="144"
              height="53"
              alt
          ...
          <div class="flame" style="right: -45px; bottom: 5px">
            <img
              src="../../../assets/video/images/flame.png"
              width="49"
              height="11"
              alt
            />
        ...
        <div class="car2" id="car2">
          <img
            src="../../../assets/video/images/ft/car2.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="164"
            height="44"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car2.png"
            v-else
            width="164"
            height="44"
            alt
        ...
        <div class="car3" id="car3">
          <img
            src="../../../assets/video/images/ft/car3.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="170"
            height="47"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car3.png"
            v-else
            width="170"
            height="47"
            alt
        ...
        <div class="car4" id="car4">
          <img
            src="../../../assets/video/images/ft/car4.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="173"
            height="47"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car4.png"
            v-else
            width="173"
            height="47"
            alt
        ...
        <div class="car5" id="car5">
          <img
            src="../../../assets/video/images/ft/car5.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="190"
            height="50"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car5.png"
            v-else
            width="190"
            height="50"
            alt
        ...
        <div class="car6" id="car6">
          <img
            src="../../../assets/video/images/ft/car6.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="201"
            height="53"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car6.png"
            v-else
            width="201"
            height="53"
            alt
          ...
          <div class="wheel6a">
            <img
              src="../../../assets/video/images/sc/wheel.gif"
              v-if="curLotteryCode.indexOf('sc') != -1"
              width="22"
              height="22"
              alt
            />
        ...
        <div class="car7" id="car7">
          <img
            src="../../../assets/video/images/ft/car7.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="210"
            height="59"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car7.png"
            v-else
            width="210"
            height="59"
            alt
        ...
        <div class="car8" id="car8">
          <img
            src="../../../assets/video/images/ft/car8.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="217"
            height="59"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car8.png"
            v-else
            width="217"
            height="59"
            alt
        ...
        <div class="car9" id="car9">
          <img
            src="../../../assets/video/images/ft/car9.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="230"
            height="66"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car9.png"
            v-else
            width="230"
            height="66"
            alt
        ...
        <div class="car10" id="car10">
          <img
            src="../../../assets/video/images/ft/car10.png"
            v-if="curLotteryCode.indexOf('ft') != -1"
            width="241"
            height="66"
            alt
          />
          <img
            src="../../../assets/video/images/sc/car10.png"
            v-else
            width="241"
            height="66"
            alt
        ...
        >
          ...
          <div class="yellowlight" v-show="curLotteryCode.indexOf('ft') == -1">
            <img
              src="../../../assets/video/images/sc/lightyellow.png"
              width="293"
              height="193"
              alt
            />
          ...
          <div class="greenlight" v-show="curLotteryCode.indexOf('ft') == -1">
            <img
              src="../../../assets/video/images/sc/lightgreen.png"
              width="293"
              height="193"
              alt
            />
      ...
      <div class="resultpage page2" style="display: none">
        <div class="resultitm result1" id="result1" style="opacity: 1">
          <img
            src="../../../assets/video/images/result1.png"
            width="226"
            height="177"
            alt
          />
        ...
        <div class="resultitm result2" id="result2" style="opacity: 1">
          <img
            src="../../../assets/video/images/result2.png"
            width="258"
            height="139"
            alt
          />
        ...
        <div class="resultitm result3" id="result3" style="opacity: 1">
          <img
            src="../../../assets/video/images/result3.png"
            width="173"
            height="112"
            alt
          />
        ...
        >
          <img src="" width="422" height="184" alt class="resultcarimg2" />
        </div>
        <div
        ...
        >
          <img src="" width="384" height="166" alt class="resultcarimg3" />
        </div>
        <div
        ...
        >
          <img src="" width="510" height="222" alt class="resultcarimg1" />
        </div>
      </div>
      <div class="footer">
        <div class="footer1">
      ...
      <div class="soundbox">
        <audio
          :src="require('../../../assets/video/sound/cuttime.mp3')"
          id="sound"
        ></audio>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ZHLH() {
      let k = this.openResult;
      let arr = [];
      arr[0] = k[0] / 1 + k[1] / 1;
      arr[1] = k[0] / 1 + k[1] / 1 >= 12 ? "大" : "小";
      arr[2] = (k[0] / 1 + k[1] / 1) % 2 == 1 ? "单" : "双";
      arr[3] = k[0] / 1 > k[9] / 1 ? "龙" : "虎";
      arr[4] = k[1] / 1 > k[8] / 1 ? "龙" : "虎";
      arr[5] = k[2] / 1 > k[7] / 1 ? "龙" : "虎";
      arr[6] = k[3] / 1 > k[6] / 1 ? "龙" : "虎";
      arr[7] = k[4] / 1 > k[5] / 1 ? "龙" : "虎";
      return arr;
    },
  },
  created() {
    if (this.lotteryName.indexOf("飞艇") > -1) {
      this.curLotteryCode = "ft";
    } else {
      this.curLotteryCode = "";
    }
  },
  mounted() {
    this.$nextTick(() => {
      ...
      var W = document.querySelector(
        "#app > div.lotteryPage.lotteryPage_PK10 > div.titleBar_top > div.liveVideo"
      ).offsetWidth;
      var zoomW = W / 1200;
      var W = 1200;
      var zoomW2 = W / 1335;
      $("#layaContainer .container").css("zoom", zoomW2);
      $(".pk10Live").css("zoom", zoomW);
  ...
  methods: {
    insertDataWarp(isOPen) {
      var ticking = isOPen ? 0 : this.OpenTime; //0的时候进入加载状态
      if (this.firstLoad) {
        settingIsOpen(true);
        this.firstLoad = false;
        this.insertData(ticking);
      } else {
        finishgame(this.suijiOpenResultData);
        setTimeout(() => {
          ticking = this.OpenTime;
          this.insertData(ticking - 10 < 0 ? 0 : ticking - 10);
        }, 10000);
      }
    },
    ...
    insertData(ticking) {
      ...
      showcurrentresult(this.suijiOpenResultData);
      // 已开奖期数
      $("#currentdrawid").text(this.periodId);
      // 开奖期号
      $("#nextdrawtime").text(this.order);
      // 冠亚和数据
      $("#stat1_1").text(this.ZHLH[0]);
      $("#stat1_2").text(this.ZHLH[1]);
      $("#stat1_3").text(this.ZHLH[2]);
      // 龙虎
      for (var i = 0; i < 5; i++) {
        $("#stat2_" + (i + 1)).text(this.ZHLH[i + 3]);
      }
    },
  },
  destroyed() {
